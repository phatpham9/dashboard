...
angular
    ...
    .controller('groupDetails', ['$scope', '$state', '$stateParams', 'translate', 'logger', 'groupAPI', 'userAPI', 'settingAPI',
        function($scope, $state, $stateParams, translate, logger, groupAPI, userAPI, settingAPI) {
